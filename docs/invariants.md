...
- The App home path is a Codex CLI fixed-executor experience with built-in MAS/MAG/RCA purpose entries. It must not expose Aion CLI, Claude Code, generic backend switching, home model override lists, or permission-mode selectors as normal user choices.
