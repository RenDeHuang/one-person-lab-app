...
| [`gui/opl-studio-plan.md`](gui/opl-studio-plan.md) | `opl-studio` foreground alternative candidate decision, external-learning landing, non-live product-surface target, and staged evidence plan. |
