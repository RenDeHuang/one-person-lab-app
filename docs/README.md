...
| [`product/gui/computer-use.md`](product/gui/computer-use.md) | Default KimiCU desktop provider, Standard/Full parity, TCC state, browser route, work packages and acceptance; `active_ssot` | Product/install target only; Framework/Shell source and clean-VM readback prove implementation |
