...
<li>可用模型访问方式；已有可用 Codex/OpenAI 登录或其它 provider 时可先跳过首启 Gateway 配置。</li>
...
<!--
本教程用于 macOS App 首次安装和首启说明。截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03 的中文截图资产。
-->
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>2 / 10</span></div>
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>3 / 10</span></div>
...
<header class="step-title">
  <h1>3. 配置访问权限</h1>
  <p>首次启动会先检查模型访问；已有可用 Codex/OpenAI 登录或其它 provider 时，可先跳过 OPL Gateway 配置。完全没有可用模型访问时，可向...</p>
</header>
...
<main class="step-layout">
  ...
  <aside class="focus">
    <h2>本页重点</h2>
    <ul><li>拿到访问密钥后，在页面输入 OPL Gateway 访问密钥。</li>
<li>点击配置 OPL Gateway 后继续首启检查；跳过的用户之后仍可在 Settings 中切换到 OPL Gateway。</li>
<li>不要截图、转发或保存密钥到研究目录。</li></ul>
  </aside>
</main>

<p class="body-line">首次启动会先检查模型访问；已有可用 Codex/OpenAI 登录或其它 provider 时，可先跳过 OPL Gateway 配置。完全没有可用模型访问时，可向本团队获取 OPL Gateway 访问密钥，并在首启页面完成配置。</p>
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>4 / 10</span></div>

<!--
首次启动会先检查模型访问；已有可用 Codex/OpenAI 登录或其它 provider 时，可先跳过 OPL Gateway 配置。完全没有可用模型访问时，可向本团队获取 OPL Gateway 访问密钥，并在首启页面完成配置。 拿到访问密钥后，在页面输入 OPL Gateway 访问密钥。 点击配置 OPL Gateway 后继续首启检查；跳过的用户之后仍可在 Settings 中切换到 OPL Gateway。 不要截图、转发或保存密钥到研究目录。
-->
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>5 / 10</span></div>
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>6 / 10</span></div>
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>7 / 10</span></div>
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>8 / 10</span></div>
...
<div class="footer"><span class="source-line">截图来自 mixed-vm-and-rendered-guide-assets-2026-07-03；PNG 保留原始尺寸。</span><span>9 / 10</span></div>
...
<li>访问权限未配置：没有可用 Codex 登录、provider 或 OPL Gateway 访问时，向本团队获取 OPL Gateway 访问密钥，并在首启页面或 Settings 中完成配置。</li>
<li>模块未就绪：在本机运行环境或关于与更新中重新检查维护状态。</li></ul>
  </div>
  <div class="notes">
    <h2>验证来源</h2>
...
<div class="footer"><span>GitHub Release 下载入口: <a href="https://github.com/gaofeng21cn/one-person-lab-app/releases/latest">https://github.com/gaofeng21cn/one-person-lab-app/releases/latest</a></span><span>10 / 10</span></div>
