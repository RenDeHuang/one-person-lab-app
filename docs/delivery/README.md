...
| [`install/README.md`](install/README.md) / [`中文`](install/README.zh-CN.md) | English-default, bilingual Desktop/WebUI/Headless choice, unified installer, platform matrix, verification, update, and rollback source. |
