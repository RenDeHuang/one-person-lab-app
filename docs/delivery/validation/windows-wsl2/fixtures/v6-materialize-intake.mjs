...
const packetFiles = [
  ...
  },
  {
    ...
    role: 'windows_guest_three_phase_visible_smoke',
  },
  {
  ...
  {
    source: '../windows-platform/README.md',
    role: 'windows_c_root_factory_runbook',
  },
  {
    source: '../windows-platform/windows-platform-factory-plan.json',
    role: 'windows_c_root_factory_plan',
  },
  {
    source: '../windows-platform/windows-platform-vm-request.schema.json',
    role: 'windows_c_root_vm_request_schema',
  },
  {
    source: '../windows-platform/windows-platform-vm-lease.schema.json',
    role: 'windows_c_root_platform_lease_schema',
  },
  {
    source: '../windows-platform/windows-platform-clean-vm-attestation.schema.json',
    role: 'windows_c_root_clean_vm_attestation_schema',
  },
  {
    source: '../windows-platform/windows-platform-post-resize-gate.schema.json',
    role: 'windows_post_resize_factory_gate_schema',
  },
  {
    source: '../windows-platform/fixtures/New-OPLWindowsVMRequest.ps1',
    role: 'windows_fresh_c_root_request_generator',
  },
  {
    source: '../windows-platform/fixtures/Test-OPLHyperVStorageCompatibility.ps1',
    role: 'windows_c_root_storage_probe',
  },
  {
    source: '../windows-platform/fixtures/New-OPLWindows11VM.ps1',
    role: 'windows_c_root_vm_factory',
  },
  {
    source: '../windows-platform/fixtures/New-OPLVMIsolatedNetwork.ps1',
    role: 'windows_per_vm_isolated_network_factory',
  },
  {
    source: '../windows-platform/fixtures/Seal-OPLCleanWindowsBaseline.ps1',
    role: 'windows_clean_zh_cn_baseline_attestation',
  },
  {
    source: '../windows-platform/fixtures/Grant-OPLVMLease.ps1',
    role: 'windows_c_root_platform_lease_grant',
  },
  {
    source: '../windows-platform/fixtures/Grant-OPLV6WriterLease.ps1',
    role: 'windows_exact_v6_writer_lease_grant',
  },
];
  ...
  return {
    ...
    source_refs: {
      ...
      framework: {
        ...
        git_sha: FRAMEWORK_FIXTURE_SHA,
        root_tree_sha: FRAMEWORK_TREE_SHA,
        cli_blob_path: FRAMEWORK_CLI_PATH,
        cli_blob_git_sha: FRAMEWORK_CLI_BLOB_GIT_SHA,
        cli_blob_sha256: FRAMEWORK_CLI_BLOB_SHA256,
      },
    },
    toolchain_contract: {
      node_range: '>=22 <25',
