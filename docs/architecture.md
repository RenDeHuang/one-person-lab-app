...
| Companion Tools | Packaged support tools and skills such as cron, OfficeCLI, PDF, MinerU, and UI/UX helpers. Superpowers remains user-owned and outside the App payload. |
