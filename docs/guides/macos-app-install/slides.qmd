...
推荐在“终端”运行稳定版安装命令；不方便使用终端时，再从最新 Release 手工下载 arm64 DMG。

最新版本：<{{download.latest_release_url}}>

![](screenshots/01-download-release.png){width=78%}

- 安装命令会写入 `/Applications`、清理 quarantine 并打开 App。
- 手工安装选择 `One-Person-Lab-<版本>-mac-arm64.dmg`。
...
- 打不开 App：确认已复制到 Applications，或重新运行稳定版安装命令。
