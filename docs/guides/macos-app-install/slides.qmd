...
- 首次安装选 Full DMG；刚发版时如仍在追加，请等待同一 Release 的 Full 出现。
...
- 第一条任务同时说明目标和材料位置。
- 8.22 当前显示科研、基金申请、视觉交付和智能体构建入口；入口随 Package 投影变化。
...
- 下载文件很多：首次安装选择 `Full-<版本>-mac-arm64.dmg`，刚发版时等待同一 Release 追加完成。
