...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `c41bfdb58eaf111e731e544f73d716f8d3bb3032`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
