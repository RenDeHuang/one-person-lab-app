...
| Runtime owner-action default | `landed_contract_backed` | Runtime page default attention is project progress plus next visible owner action: next step, next owner, delta class, and blocker state appear before full evidence ledger detail. Full ledger detail is on-demand diagnostic, audit, or release evidence only. |
