...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `de444a09c474741a8dfbc7df89249447f002d4ff`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
