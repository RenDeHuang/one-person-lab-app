...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `e4b40d520309de32cfe3acaca61a58dcb97289d3`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
