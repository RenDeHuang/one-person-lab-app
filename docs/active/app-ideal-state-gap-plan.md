...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `06593c00dab72f995b9bf42d7c6a2924c5dafe84`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
