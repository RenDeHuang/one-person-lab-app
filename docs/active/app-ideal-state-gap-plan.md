...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `19bc89cca3114af9856d09886362aed615dfa1e2`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
