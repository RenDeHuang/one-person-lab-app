...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `c7956710cc464addac69ee66e11107b87ccec170`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
