...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `30b4b4544dbb4265773d714b4b7cf55e66f13637`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
