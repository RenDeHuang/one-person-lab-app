...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `fbce423c7a698048dd4422020541a004785e5d82`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
