...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `4c775769ff68bf45929210181cc86e815a93c43d`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
