...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `85ec6cb020451a351bfa708c58e01694f481ac55`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
