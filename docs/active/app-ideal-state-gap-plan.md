...
| Active shell upstream intake | `landed_verified` | `contracts/app-shell-adapter.json` records the current active shell upstream ref `fb74068bc5b35dc7d17e2f405b1f63b2866fa96d`; shell implementation history stays in `gaofeng21cn/opl-aion-shell`. |
