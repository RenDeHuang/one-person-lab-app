export declare const CHANNEL_PROVIDER_ID: "opl-channel-weixin";
export declare const CHANNEL_CALLBACK_API_VERSION: "1.0.0";
...
export type ChannelTurnCallback = {
    ...
    startTurn: (input: CanonicalThreadRef & {
        text: string;
    }) => Promise<CanonicalTurnRef>;
...
export type WeixinDiagnosticCode = 'poll_failed' | 'message_invalid' | 'callback_failed' | 'turn_identity_mismatch' | 'turn_failed' | 'turn_cancelled' | 'turn_completed_empty' | 'send_failed';
