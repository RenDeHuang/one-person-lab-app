...
function main(): void {
  ...
  if (checkOnly) {
    ...
    console.log(JSON.stringify({ status: 'current', authority: contractPaths.productProfile }, null, 2));
    return;
  }
  console.log(JSON.stringify({
    status: 'synced',
    authority: `${contractPaths.productProfile}#codex.auto_model_policy.configured_default`,
