...
export function buildFullFirstInstallReadme(input: {
  ...
  return [
    ...
    '5. The Full runtime includes the Codex CLI, officecli CLI binary, OPL Meta Agent, and recommended companion skills such as MAS, MAG, RCA, officecli, officecli-docx, officecli-pptx, officecli-xlsx, and ui-ux-pro-max. App initialization makes those payloads visible to Codex without requiring Command Line Tools or git to finish first.',
