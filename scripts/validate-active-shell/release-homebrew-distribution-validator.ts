  ...
  assertExpectedFields(
    [
      ...
      { actual: tapUpdate?.download_source, expected: 'app_owned_github_release_asset_url' },
      {
        ...
        expected: 'release_bundle_protected_job_digest_bound_direct_commit',
      },
      { actual: tapUpdate?.default_workflow_repo, expected: 'gaofeng21cn/one-person-lab-app' },
      { actual: tapUpdate?.default_workflow, expected: '.github/workflows/_release-bundle.yml' },
      ...
      { actual: tapUpdate?.app_release_direct_workflow, expected: '.github/workflows/_release-bundle.yml' },
      ...
      { actual: tapUpdate?.app_release_pull_request_allowed, expected: false },
      {
        ...
        expected: 'protected_environment_single_attempt_digest_bound_direct_commit',
      },
      {
