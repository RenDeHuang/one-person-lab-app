...
function expectedAgentPackageLifecycleUx() {
  return {
    ...
    failure_reason_fields: [
      ...
      'capability_exposure.enabled',
      'capability_exposure.visibility',
      'use_boundary_action.reason_code',
      'use_boundary_action.blocker.source_ref',
      'use_boundary_action.blocker.recovery_action_ref',
      'package_dependency_readiness.status',
      'package_dependency_readiness.dependencies[].reasons',
      'materialization_readiness.status',
      'runtime_source_readiness.reason',
      'status_read_error',
      'operational_ready',
      'launch_allowed',
    ...
    package_projection_contract: {
      directory_fast_nested_fields: {
        ...
        exposure: ['enabled', 'visibility', 'codex_visible'],
        use_boundary_action: ['surface_kind', 'action_id', 'action_ref', 'payload', 'required_payload_fields', 'confirmation_required', 'use_boundary_id', 'directory_entry_ref', 'readiness_ref', 'enabled', 'preparation_status', 'reason_code', 'blocker'],
      ...
      directory_lifecycle_fields: ['installed', 'activated', 'installability', 'readiness', 'exposure', 'use_boundary_action', 'recommended_action', 'recommended_action_ref', 'available_actions'],
      directory_readiness_status_values: ['not_installed', 'activation_required', 'verification_deferred', 'ready', 'attention_needed', 'migration_required', 'repair_required'],
      status_index_join_policy: 'required_package_id_keyed_lifecycle_diagnostics_directory_lifecycle_readiness_and_exact_actions_win_on_overlap',
      status_index_package_fields: {
        surface_kind: 'string',
        package_id: 'string',
        status: 'string',
        package_version: 'null_or_string',
        installed_version: 'null_or_string',
        version: 'null_or_string',
        source_kind: 'null_or_string',
        package_lock_ref: 'null_or_string',
        lock_ref: 'null_or_string',
        action_receipt_ref: 'null_or_string',
        rollback_ref: 'null_or_string',
        ...
        dependency_closure_receipt_fields: ['transaction_id', 'closure_digest', 'last_known_good_transaction_id', 'last_known_good_closure_digest'],
        package_dependency_readiness: ['status', 'operational_ready', 'repair_command', 'dependencies'],
        package_dependency_readiness_status_values: ['missing', 'current', 'incompatible'],
        dependency_item_fields: ['package_id', 'required', 'version_requirement', 'capability_abi', 'required_export_ids', 'required_module_ids', 'installed_version', 'manifest_sha256', 'content_digest', 'status', 'reasons', 'missing_required_export_ids', 'missing_required_module_ids'],
        materialization_readiness: ['status', 'scope', 'target_root', 'required_skill_ids', 'materialized_skill_ids', 'expected_digest', 'actual_digest', 'repair_command', 'lifecycle_receipt_ref', 'core_readiness', 'specialty_exposure'],
        runtime_source_readiness: ['status', 'operational_ready', 'module_id', 'checkout_path', 'expected_tree_sha256', 'actual_tree_sha256', 'reason', 'verification_mode', 'live_verification_deferred', 'live_verification_surface'],
        operational_ready: 'boolean',
        operational_ready_scope: 'string',
        ...
        repair_command: 'null_or_command_ref',
        ...
        capability_exposure: ['enabled', 'visibility', 'codex_visible'],
        physical_surface: 'null_or_refs_only_record',
        codex_visible: 'boolean',
        status_read_error: 'null_or_error_record',
        currentness_detail_deferred: 'boolean',
        detail_surface: 'string',
      },
      ...
      activation_reason_codes: ['package_not_installed', 'package_disabled', 'status_unavailable', 'scope_reconciliation_required', 'use_boundary_reconciliation_ready'],
      use_boundary_action_source: 'directory.entries[].use_boundary_action',
      status_index_repair_action_id: 'agent_package_repair',
      status_index_action_execution_policy: 'status-index repair_action and activation_action are diagnostics only; every Agent launch executes only the independent directory use_boundary_action exact action_id and payload',
      dependent_guard_missing_policy: {
      ...
      use_boundary_action_missing_policy: {
      ...
      launch_gate_policy: 'directory readiness remains positive eligibility authority, while live_verification_deferred is a prelaunch transition that must execute the independent use_boundary_action; no local relabeling may promote readiness',
      launch_pretransition_reason_codes: ['package_activation_required', 'live_verification_deferred', 'use_boundary_reconciliation_ready'],
      launch_fail_closed_reason_codes: ['package_not_installed', 'package_disabled', 'package_status_read_failed', 'package_dependency_missing', 'package_dependency_incompatible', 'physical_surface_not_ready', 'runtime_source_missing', 'runtime_source_incompatible', 'carrier_authority_invalid', 'package_lock_corrupt', 'package_ledger_corrupt', 'package_recovery_in_progress', 'package_recovery_required'],
      role_launch_matrix: {
    ...
    receipt_physical_surface_detail_policy: {
      ...
      receipt_fields: [
        ...
        'dependency_closure.last_known_good_transaction_id',
