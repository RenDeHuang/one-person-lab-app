...
function expectedAgentPackageLifecycleUx() {
  return {
    ...
    package_projection_contract: {
      ...
      directory_lifecycle_fields: ['installed', 'activated', 'installability', 'readiness', 'recommended_action', 'recommended_action_ref', 'available_actions'],
      ...
      status_index_package_fields: {
        ...
        capability_exposure: ['status', 'codex_visible'],
      ...
      directory_activation_action_source: 'directory.entries[].available_actions[action_id=agent_package_activate]',
      status_index_repair_action_id: 'agent_package_repair',
      status_index_action_execution_policy: 'status-index repair_action and activation_action expose availability and reason only; execution still requires the matching directory.entries[].available_actions exact five-field object and payload',
      ...
      activation_action_missing_policy: {
      ...
      launch_gate_policy: 'directory.entries[].readiness owns ordinary launch eligibility; status_index false or verification-deferred signals may only fail closed and never promote directory readiness',
      launch_fail_closed_reason_codes: ['package_not_installed', 'package_activation_required', 'live_verification_deferred', 'package_status_read_failed'],
