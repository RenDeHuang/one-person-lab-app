...
function validateDeliveryTopology(profile) {
  ...
  assertDeepEqualJson(
    topology.headless_webui,
    {
      ...
      background_service_source_implemented: false,
      installer_source_implemented: false,
      update_source_implemented: false,
      ...
      implementation_gap: 'add_background_service_install_and_carrier_update_entry',
  ...
  assertDeepEqualJson(
    topology.docker_webui,
    {
      ...
      distribution_install_source_implemented: false,
      image_update_recreate_source_implemented: false,
  ...
  assertDeepEqualJson(
    topology.minimum_complete_product,
    {
      ...
      composition_model: {
        ...
        cordis_learning: 'service_provider_consumer_and_lifecycle_composition_principles_only',
