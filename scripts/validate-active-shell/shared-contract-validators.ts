...
export function assertFirstRunProgressModelShape(progressModel, label) {
  ...
  assertNonEmptyStringArray(progressModel.required_setup_flow_fields, `${label} required_setup_flow_fields`);
  assertNonEmptyStringArray(progressModel.required_progress_fields, `${label} required_progress_fields`);
  assertNonEmptyStringArray(progressModel.required_checklist_fields, `${label} required_checklist_fields`);
  assertNonEmptyStringArray(progressModel.required_visible_elements, `${label} required_visible_elements`);
}
