  ...
  assertDeepEqualJson(
    policy?.transport_binding_projection,
    {
      ...
      binding_field_contract: {
        ...
        package_id: 'installed_provider_package_identity',
        transport_id: 'stable_transport_identity_such_as_weixin',
        transport_conversation_id: 'opaque_provider_owned_transport_conversation_identity',
        canonical_thread_host: 'canonical_codex_app_server_host_identity',
        canonical_thread_id: 'opaque_codex_app_server_thread_identity',
      ...
      provider_absent_policy: 'status_unavailable_reason_producer_absent_and_temporary_legacy_fallback_may_run_until_cutover',
      binding_identity_policy: 'one_entry_per_package_id_transport_id_transport_conversation_id',
      ...
      temporary_legacy_fallback: {
        status: 'active_bounded_until_shared_callback_e2e',
        ...
        retirement_gate: 'provider_callback_plus_aionui_and_studio_callback_e2e_plus_legacy_caller_zero',
      },
      post_cutover_legacy_read_compatibility: 'after_shared_e2e_cutover_may_read_an_existing_local_canonical_thread_id_only_when_the_exact_canonical_directory_identity_still_exists_and_no_current_framework_binding_conflicts_never_infer_or_write_a_new_binding',
