...
function validateCanonicalConversationContinuityPolicy(runtimeBridge) {
  ...
  for (const [field, expected] of Object.entries({
    state: 'active_aionui_history_boundary',
    thread_truth_owner: 'codex_core_app_server_for_canonical_execution_threads',
    canonical_identity: 'host_identity_plus_opaque_app_server_thread_id',
    ordinary_rail_authority: 'opl_conversation_store_only',
    shell_local_storage_role: 'authoritative_opl_conversation_store_for_ordinary_history_and_ui_metadata',
    codex_core_owns_canonical_thread_history: true,
    opl_conversation_store_owns_ordinary_history: true,
    canonical_codex_scope: 'explicit_known_conversation_open_and_lifecycle_only',
    canonical_directory_enumeration_allowed_for_ordinary_rail: false,
    codex_app_server_row_injection_policy: 'forbidden',
    ordinary_row_source_policy: 'opl_conversation_store_rows_excluding_codex_app_server_source',
    ...
    active_aionui_status: 'ordinary_history_isolated_to_opl_conversation_store',
    opl_native_workbench_status: 'must_preserve_the_same_history_boundary_before_adoption',
    ...
    row_identity: 'opl_conversation_id',
    duplicate_row_per_opl_conversation_allowed: false,
    title_based_deduplication_allowed: false,
    e2e_fixture_storage_policy: 'isolated_storage_root_never_production_user_data',
    acceptance:
      'ordinary_rail_lists_only_opl_conversation_store_and_known_canonical_refs_remain_explicit_lifecycle_only',
    implementation_status:
      'active_aionui_history_boundary_implemented_native_continuity_not_proven',
  })) {
    if (policy?.[field] !== expected) {
  ...
  assertDeepEqualJson(
    ...
    {
      source: 'explicit_opl_workspace_affinity_metadata',
      ...
      project_directory_cardinality: 'one_explicit_project_affinity_one_directory_group',
      ...
      project_adoption_policy: {
        eligible_state: 'authoritative_workspace_affinity_is_temporary_or_none',
