...
export function validatePageStateMatrix(matrix, contract, guiProductContract) {
  ...
  if (
    JSON.stringify(matrix.remote_companion) !== JSON.stringify({
      ...
      state_rules: {
        invite_required: 'show_invitation_entry_without_creating_provider_identity_or_reserving_a_pair_seat',
        invite_rejected: 'show_a_specific_invitation_error_and_keep_pairing_disabled',
        capacity_unavailable: 'show_pairing_unavailable_without_automatic_retry_or_provider_identity_creation',
        ...
        pairing_provisioning: 'show_broker_authoritative_progress_and_keep_conversation_actions_disabled',
        ...
        paired_ready: 'show_canonical_conversation_directory_and_allow_only_projected_actions',
