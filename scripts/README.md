...
| `validate-standard-latest-admission.ts` | Admits either the default qualified-Stable Latest takeover or one explicit Preview override against protected single-use authority, expected-current CAS, exact manifest/tag/digest identity, gate disclosure, and public post-mutation readback. |
