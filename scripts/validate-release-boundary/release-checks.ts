...
export const releaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      "opl-source-qualification-$SOURCE_QUALIFICATION_RUN_ID",
      "source-qualification-receipt.ts verify",
      "--expected-digest \"$SOURCE_QUALIFICATION_RECEIPT_DIGEST\"",
      "accepts only one immutable source qualification run and receipt digest",
      "protected-admission:",
      "environment: release-stable",
