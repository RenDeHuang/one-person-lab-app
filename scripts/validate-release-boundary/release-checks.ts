...
export const releaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      "OPL_RELEASE_NOTES_AI_TIMEOUT_SECONDS: '30'",
      ...
      "always() && steps.full_package_build.outcome == 'success'",
      ...
      "inputs.publish_to_release && format('opl-app-release-mutation-{0}', inputs.opl_version)",
    ],
    forbidden: [
      'npm run gui:release',
  ...
  },
  {
    ...
    required: [
      ...
      'repository: gaofeng21cn/opl-flow',
      'ref: 06cb8e15490e6a98b1196bfc6d526bd50471ecbc',
      'path: opl-flow',
  ...
  },
  {
    ...
    required: [
      ...
      'webui-ghcr-publish:',
      "version=\"$(date -u +'%y.%-m.%-d')-nightly.${GITHUB_RUN_ID}.${GITHUB_RUN_ATTEMPT}\"",
      'npm run release:version:validate -- --channel nightly --version "$version"',
      'cancel-in-progress: false',
      'Nightly tag ${OPL_RELEASE_TAG} already exists; every run must use a unique immutable version.',
      'Nightly release ${OPL_RELEASE_TAG} already exists; every run must create a new version.',
      'git tag "${OPL_RELEASE_TAG}" "$GITHUB_SHA"',
  ...
  },
  {
    ...
    required: [
      ...
      'OPL_FLOW_SHA=${{ inputs.opl_flow_ref }}',
    ],
    forbidden: [
      'uses: ./.github/workflows/opl-first-run-vm.yml',
      'uses: ./.github/workflows/_build-reusable.yml',
  ...
  },
  {
    ...
    required: [
      ...
      '--build-arg OPL_WEBUI_IMAGE_PROFILE=webui-slim',
      '--build-arg "OPL_FLOW_REF=${OPL_FLOW_SHA}"',
  ...
  },
  {
    ...
    required: [
      ...
      'Nightly Homebrew tap updates must use YY.M.D-nightly.<run_id>.<run_attempt>.',
      'Stable Homebrew tap updates must use YY.M.D without a same-day suffix.',
  ...
  },
  {
    ...
    required: [
      ...
      'expected YY.M.D without a same-day suffix',
      'release_target',
      'tap_update_required',
  ...
  },
  {
    ...
    required: [
      ...
      'opl_flow_ref:',
      'default: 06cb8e15490e6a98b1196bfc6d526bd50471ecbc',
      'name: Checkout OPL Flow policy source',
  ...
  },
  {
    ...
    required: [
      ...
      'npm run verify-remote-release',
      'Validate exact Full qualification receipt',
      'Verify same-cohort add-on readiness',
      'Resolve release owner gate with exact qualification override',
      ...
      'Dispatch atomic Stable distribution',
      'Reusing immutable Stable distribution receipt',
      'package_profile: homebrew-standard',
      'package_profile: homebrew-full',
      'Aggregate both Homebrew VM receipts',
      'Activate Stable latest after all distribution gates',
