...
export const releaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      '--field full_vm_evidence_base64="$FULL_VM_EVIDENCE_BASE64"',
      ...
      "Activate WebUI Stable and App latest after all distribution gates",
      "Promote exact immutable WebUI image to Stable",
      "oras tag \"${WEBUI_IMAGE}@${WEBUI_VERSION_DIGEST}\" stable",
      "opl_webui_stable_activation_receipt.v1",
