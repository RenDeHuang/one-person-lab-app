...
export const releaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      'OPL_RELEASE_NOTES_GITHUB_MODELS',
      'openai/gpt-4o-mini',
      'openai/gpt-4.1-mini',
      ...
      'OpenAI-compatible release-note provider unavailable; trying GitHub Models legacy provider.',
      'GitHub Models legacy release-note provider unavailable; trying Codex provider.',
      'runCodexProvider',
