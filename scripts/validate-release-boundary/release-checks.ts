...
const legacyReleaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      "ref: ${{ needs.validate-vm-inputs.outputs.verification_app_sha }}",
...
export const releaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      "verification_app_ref: ${{ inputs.smoke_harness_ref != '' && 'ad8403fba6372bf67574f5d72144d6ae1ffb9f61' || needs.restore-standard.outputs.app_ref }}",
