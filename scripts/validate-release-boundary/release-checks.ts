...
const legacyReleaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      "node-version: '24'",
      "scripts/verify-apple-release-credentials.ts",
      "Seal exact Stable admission manifest",
...
export const releaseBoundaryChecks: ReleaseBoundaryCheck[] = [
  ...
  },
  {
    ...
    required: [
      ...
      "opl-stable-admission-$ADMISSION_RUN_ID",
      "stable-release-admission-manifest.ts verify",
      "--expected-digest \"$ADMISSION_MANIFEST_DIGEST\"",
      "accepts only the immutable admission run and manifest digest",
