...
const checks = [
  ...
  {
    id: 'release_asset_gatekeeper_verifiers',
  ...
  },
  {
    ...
    required: [
      ...
      'quarantine_before',
      'quarantine_after',
      'signed and notarized releases are still required',
    ],
    forbidden: [],
  },
  {
  ...
  },
  {
    ...
    required: [
      ...
      'quarantine_after=0',
      'not a Stable release replacement',
    ],
    forbidden: [],
  },
  {
    ...
    required: [
      ...
      '"stable_release_replacement_allowed": false',
