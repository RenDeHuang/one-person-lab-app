...
const checks = [
  ...
  },
  {
    ...
    required: [
      ...
      'node --experimental-strip-types scripts/write-release-evidence-manifest.ts --bundle-dir "$bundle_dir" --overwrite',
      ...
      'Build release closeout summary',
      'npm run release:closeout --',
      '--no-download',
      'release-closeout-inputs',
      'release-closeout/release-closeout.json',
      'release-closeout/release-closeout.md',
      'Upload release closeout summary',
  ...
  },
  {
    ...
    required: [
      ...
      'OPL_RELEASE_NOTES_EVIDENCE_OUTPUT',
      "process.env.OPL_RELEASE_NOTES_MODE || 'template'",
