...
test('Nightly release workflow publishes standard-only semver prereleases', () => {
  ...
  assert.match(workflow, /OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_BASE_URL: \$\{\{ vars\.OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_BASE_URL \|\| vars\.OPL_RELEASE_NOTES_CODEX_BASE_URL \}\}/);
  assert.match(workflow, /OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_API_KEY: \$\{\{ secrets\.OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_API_KEY \|\| secrets\.OPL_RELEASE_NOTES_CODEX_API_KEY \}\}/);
...
test('release workflows resolve moving refs once and pass fixed SHA cohort refs downstream', () => {
  ...
  assert.match(workflowJobBlock(desktopWorkflow, 'publish-standard'), /OPL_RELEASE_NOTES_PROVIDER: openai_compatible/);
  assert.match(workflowJobBlock(desktopWorkflow, 'publish-standard'), /OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_BASE_URL: \$\{\{ vars\.OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_BASE_URL \|\| vars\.OPL_RELEASE_NOTES_CODEX_BASE_URL \}\}/);
  ...
  assert.match(workflowJobBlock(desktopWorkflow, 'publish-full-assets'), /OPL_RELEASE_NOTES_PROVIDER: openai_compatible/);
  assert.match(workflowJobBlock(desktopWorkflow, 'publish-full-assets'), /OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_API_KEY: \$\{\{ secrets\.OPL_RELEASE_NOTES_OPENAI_COMPATIBLE_API_KEY \|\| secrets\.OPL_RELEASE_NOTES_CODEX_API_KEY \}\}/);
  assert.match(desktopWorkflow, /node --experimental-strip-types scripts\/release-notes-ai-writer\.ts --probe-openai-compatible/);
