...
test('release workflows resolve moving refs once and pass fixed SHA cohort refs downstream', () => {
  ...
  assert.match(workflowJobBlock(desktopWorkflow, 'publish-standard'), /OPL_RELEASE_NOTES_CODEX_BASE_URL: \$\{\{ vars\.OPL_RELEASE_NOTES_CODEX_BASE_URL \}\}/);
  ...
  assert.match(workflowJobBlock(desktopWorkflow, 'publish-full-assets'), /OPL_RELEASE_NOTES_CODEX_API_KEY: \$\{\{ secrets\.OPL_RELEASE_NOTES_CODEX_API_KEY \}\}/);
