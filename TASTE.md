...
3. **阶段推进任务**
   ...
   大型任务以阶段作为可观察、可恢复、可审计的推进单位。每个阶段明确目标、输入输出、工具、知识、质量门、交接方式和验收记录；阶段内由合适执行者自主完成专家工作。
...
11. **最小充分验证**
    ...
    验证强度与风险匹配。行为不变、文档治理、结构收薄和命名清理采用最小充分验证；生产声明、权限边界、数据或产物写入、发布、质量结论和跨系统责任边界使用更重的回执、截图、发布记录、责任链或长时间运行证据。
